...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form class="multisteps-form__form">
                                    ...
                                    <div class="col-12 col-lg-8 m-auto">
                                        <div id="step-1" class="multisteps-form__panel padd__holder bg-white js-active"
                                            ...
                                            <div class="multisteps-form__content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="dropbox-container" id="dropbox1">
                                                            <div class="file-input-wrap">
                                                                <input type="file" name="thesis" id="thesis" class="file-input" />
                                                                <label class="file-input__btn" for="thesis">
                                                                    <p>Drop files here or click to select</p>
                                                                </label>

                                                                <!-- <input type="file" name="file" class="file-input" id="dropFileInput" /> -->

                                                                <!-- <label class="file-input__btn" for="dropFileInput" id="dropbox" ondrop="handleDrop(event)" ondragover="handleDragOver(event)">
                                                                    <p>Drop files here or click to select</p>
                                                                    </label> -->
                                                                ...
                                                                <div class="dropbox__preview">
                                                                    ...
                                                                    <button type="button" class="dropbox__btn--preview-close"><i class="fa-solid fa-cloud-arrow-up"></i></button>
                                                                </div>

                                                                <span class="error-text">*Please upload a pdf.</span>
                                                            </div>

                                                            <div class="dropbox__progress-bar"></div>
                                                            <span class="dropbox__progress-percentage"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                         <div class="dropbox-container" id="dropbox1">
                                                            <div class="file-input-wrap">
                                                                <input type="file" name="synopsis" id="synopsis" class="file-input" />
                                                                <label class="file-input__btn" for="synopsis">
                                                                    <p>Drop files here or click to select</p>
                                                                </label>
                                                                ...
                                                                <div class="dropbox__preview">
                                                                    ...
                                                                    <button class="dropbox__btn--preview-close"><i
                                    ...
                                    <div id="step-2" class="multisteps-form__panel bg-white" data-animation="scaleIn">
                                        <div class="multisteps-form__content">
                                            ...
                                            <div class="button-row d-flex mt-4 col-12">
                                                ...
                                                <button disabled class="btn next__button ml-auto js-btn-next"
                                                    type="button" title="Next" id="next_step_3">
                                                    Next
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="step-3" class="multisteps-form__panel bg-white" data-animation="scaleIn">
                                                                                ...
                                                                                <div class="col-sm-6 mb-4">
                                                                                    <div class="searche__wrapp">
                                                                                        ...
                                                                                        <select id="inlineFormCustomSelect"
                                                                                            ...
                                                                                            <option value="A4 - Full">A4 -
                                                                                                Full</option>
                                                                                            <option
                                                                                                value="A4 - 95% Reduction">
                                                                                                A4 - 95% Reduction</option>
                                                                                            <option value="A4 - 90%">A4 -
                                                                                                90%</option>
                                                                                            <option value="A4 - 85%">A4 -
                                                                                                85%</option>
                                                                                            <option value="A4 - 80%">A4 -
                                                                                                80%</option>
                                                                                            <option value="A4 - 70%">A4 -
                                                                                                70%</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                        ...
                                                        <div class="binding__details">
                                                            ...
                                                            <div class="col-md-5 p-0 mt-5">
                                                                ...
                                                                <div class="btn-container">
                                                                    ...
                                                                    <input type="file" class="fileup" value=""
                                                                        name="fileup" id="hard_binding_cover_design"
                                                                        name="hard_binding_cover_design" />
                                                                    <div class="form-group form-check mt-3 d-none">
                                                                        <input type="checkbox" class="form-check-input"
                                                                            id="exampleCheck1"
                                                                            name="hard_binding_same_as_cover" />
                                                                        <label class="form-check-label"
                                                                            for="exampleCheck1">Same as thesis
                                                                            cover</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <p>Spine Printing Details <a href="#"
                                                                    data-toggle="tooltip" title="Hooray!">
                                                                    <i class=" fa-solid fa-circle-info"
                                                                        aria-hidden="true"></i>
                                                                </a></p>
                                        ...
                                        <div class="row">
                                            <div class="button-row d-flex mt-4 col-12">
                                                ...
                                                <button disabled class="btn next__button ml-auto js-btn-next"
                                                    type="button" title="Next" id="next_step_4">
                                                    Next
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="step-4" class="multisteps-form__panel bg-white" data-animation="scaleIn">
                                                        ...
                                                        <div class="binding__details">
                                                            ...
                                                            <div class="col-md-5 p-0 mt-5">
                                                                ...
                                                                <div class="btn-container">
                                                                    ...
                                                                    <!--this is the actual file input, is set with opacity=0 beacause we wanna see our custom one-->
                                                                    <input type="file" class="fileup" value=""
                                                                        name="fileup" id="soft_binding_cover_design"
                                                                        name="soft_binding_cover_design" />
                                                                    <div class="form-group form-check mt-3 d-none">
                                        ...
                                        <div class="row">
                                            <div class="button-row d-flex mt-4 col-12">
                                                ...
                                                <button disabled class="btn next__button ml-auto js-btn-next"
                                                    type="button" title="Next" id="next_step_5">
                                                    Next
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="step-5" class="multisteps-form__panel bg-white" data-animation="scaleIn">
                                                        ...
                                                        <div class="binding__details">
                                                            <div class="spine__holder">
                                                                <div class="form-group form-check mr-3">
                                                                    <input type="radio" class="form-check-input"
                                                                        id="exampleCheck1"
                                                                        name="synopsis_binding_cover_design"
                                                                        value="Custom" />
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-group form-check mr-3"
                                                                    style="display: none;"
                                                                    id="synopsis_binding_hard_cover_design">
                                                                    <input type="radio" class="form-check-input"
                                                                        id="exampleCheck1"
                                                                        name="synopsis_binding_cover_design"
                                                                        value="Same as Hard Binding Cover" />
                                                                    <label class="form-check-label"
                                                                        for="exampleCheck1">Same as Hard Binding
                                                                        Cover</label>
                                                                </div>
                                                                <div class="form-group form-check mr-3"
                                                                    style="display: none;"
                                                                    id="synopsis_binding_soft_cover_design">
                                                                    <input type="radio" class="form-check-input"
                                                                        id="exampleCheck1"
                                                                        name="synopsis_binding_cover_design"
                                                                        value="Same as Soft Binding Cover" />
                                                                    <label class="form-check-label"
                                                                        for="exampleCheck1">Same as Soft Binding
                                                                        Cover</label>
                                                                </div>
                                                                <div class="form-group form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="exampleCheck1">Don't Need Cover
                                                                        Printing</label>
                                                                </div>
                                                            </div>
                                                            <div class="btn-container" id="synopsis_upload"
                                                                ...
                                                                <input type="file" value=""
                                                                    id="synopsis_binding_cover_design_file"
                                                                    name="synopsis_binding_cover_design_file" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="button-row d-flex mt-4 col-12">
                                                ...
                                                <button disabled class="btn next__button ml-auto js-btn-next"
                                                    type="button" title="Next" id="next_step_6">
                                                    Next
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <!--single form panel 6-->
                                    <div id="step-6" class="multisteps-form__panel p-4 bg-white"
                                        data-animation="scaleIn">
    ...
    <script>
        ...
        $(document).ready(function(event) {
            ...
            $('#thesis').on('change', function() {
                ...
                let iframe = $(this).closest('.dropbox-container').find('iframe')
                let dropbox__preview = $(this).closest('.dropbox-container').find('.dropbox__preview')
                console.log(iframe)
                ...
                fetch(apiUrl, {
                    ...
                    .then(data => {
                        ...
                        console.log("{{asset('')}}storage/" + data.file_name)
                        window.thesis_file = data.file_name
                        dropbox__preview.show()
                        iframe.attr("src", "{{asset('')}}storage/" + data.file_name)
        ...
        `);
                ...
                $('.hard_binding_card').each(function() {
                    var card = $(this);
                    card.find(
                        '[name="hard_binding_qty[]"], [name="hard_binding_a4_pockets[]"], [name="hard_binding_cd_pockets[]"], [name="hard_binding_paper_size[]"]'
                        ).on('change', function() {
        ...
        `);
                ...
                $('.soft_binding_card').each(function() {
                    var card = $(this);
                    card.find(
                        '[name="soft_binding_qty[]"], [name="soft_binding_a4_pockets[]"], [name="soft_binding_cd_pockets[]"], [name="soft_binding_paper_size[]"]'
                        ).on('change', function() {
        ...
        function validateHardBinding(card, target) {
            ...
            var pocketsFields = card.find('.searche__wrapp').has(
                '[name="hard_binding_a4_pockets[]"], [name="hard_binding_cd_pockets[]"]');
        ...
        function validateSoftBinding(card, target) {
            ...
            // Update visibility of pockets fields based on paper size
            var pocketsFields = card.find('.searche__wrapp').has(
                '[name="soft_binding_a4_pockets[]"], [name="soft_binding_cd_pockets[]"]');
            if (paperSize === "A4 - Full") {
                pocketsFields.show();
            } else {
                pocketsFields.hide();
        ...
        function generate_order_summery() {
            ...
            hard_bindings_orders.forEach(order => {
                ...
                if (order.hard_binding_qty == 1) {
                    total += (number_of_thesis_bw_page * rate.bw.first_page) + (number_of_thesis_color_page * rate
                        .color.first_page)
                } else if (order.hard_binding_qty > 1) {
                    total += (number_of_thesis_bw_page * rate.bw.first_page) + (number_of_thesis_color_page * rate
                        .color.first_page)

                    total += (((order.hard_binding_qty - 1) * number_of_thesis_bw_page) * rate.bw.other_page) + (((
                        order.hard_binding_qty - 1) * number_of_thesis_color_page) * rate.color.other_page)
                } else {
                    total += 0
                }
            ...
            soft_bindings_orders.forEach(order => {
                ...
                if (order.soft_binding_qty == 1) {
                    ...
                    total += (((order.soft_binding_qty - 1) * number_of_thesis_bw_page) * rate.bw.other_page) + (((
                        order.soft_binding_qty - 1) * number_of_thesis_color_page) * rate.color.other_page)
                } else {
                    total += 0
                }
            ...
            synopsis_bindings_orders.forEach(order => {
                ...
                if (order.synopsis_binding_qty == 1) {
                    total += (number_of_synopsis_bw_page * rate.bw.first_page) + (number_of_synopsis_color_page *
                        rate.color.first_page)
                } else if (order.synopsis_binding_qty > 1) {
                    total += (number_of_synopsis_bw_page * rate.bw.first_page) + (number_of_synopsis_color_page *
                        rate.color.first_page)

                    total += (((order.synopsis_binding_qty - 1) * number_of_synopsis_bw_page) * rate.bw
                        .other_page) + (((order.synopsis_binding_qty - 1) * number_of_synopsis_color_page) * rate
                            .color.other_page)
                } else {
                    total += 0
                }
            ...
            let sub_amount = (hard_printing_total_price + hard_binding_total_price) + (soft_printing_total_price +
                soft_binding_total_price) + (synopsis_printing_total_price + synopsis_binding_total_price)
            let cgst = 17
            let sgst = 17
    ...
    <script>
      $(document).ready(function () {
        function initDropboxFileUpload(ID) {
          const fileInputEl = $("#" + ID).find(".file-input");
          const fileInputBtn = $("#" + ID).find(".file-input__btn");

          // console.log(fileInputEl, ID);

          fileInputEl.on("input", function (event) {
            var files = event.target.files;
            handleFiles(files, ID);
          });

          fileInputBtn.on("drop", function (event) {
            fileInputBtn.removeClass("active");
            handleDrop(event, ID);
          });

          fileInputBtn.on("dragover", function (event) {
            handleDragOver(event);
            fileInputBtn.addClass("active");
          });

          fileInputBtn.on("dragleave", function (event) {
            fileInputBtn.removeClass("active");
          });
        }

        initDropboxFileUpload("dropbox1");
        initDropboxFileUpload("dropbox2");

        // document.getElementById("dropFileInput").addEventListener("input", function (event) {
        //   var files = event.target.files;
        //   handleFiles(files);
        // });
        ...
        function handleFiles(files, ID) {
          var dropbox = $("#" + ID).find(".file-input__btn");
          var progressBar = $("#" + ID).find(".dropbox__progress-bar");
          var preview = $("#" + ID).find(".dropbox__preview");
          var errorText = $("#" + ID).find(".error-text");
        ...
        //   preview.innerHTML = "";
          ...
          for (var i = 0; i < files.length; i++) {
            ...
            // preview.innerHTML += "<p>File name: " + file.name + " | Type: " + file.type + " | Size: " + file.size + " bytes</p>";
            // preview.html("<p>File name: " + file.name + " | Type: " + file.type + " | Size: " + file.size + " bytes</p>");
          ...
          // write condition for pdf and add line - "preview.show()" and add src path to its child iframe

          // Upload files (you may want to replace this with your actual file upload logic)
        ...
        function uploadFiles(files, ID) {
          ...
          var uploadedSize = 0;
          var progressBar = $("#" + ID).find(".dropbox__progress-bar");
          var progressPercentageEl = $("#" + ID).find(".dropbox__progress-percentage");

          function updateProgressBar() {
            uploadedSize += 1024; // Simulate progress update (1024 bytes at a time)

            var percentage = (uploadedSize / totalSize) * 100;
            // progressBar.style.width = percentage + "%";
            progressBar.css("width", percentage + "%");
            // progressPercentageEl.innerText = Math.floor(percentage) + "%";
            progressPercentageEl.text(Math.floor(percentage) + "%");

            if (uploadedSize < totalSize) {
              // Continue updating progress until fully uploaded
